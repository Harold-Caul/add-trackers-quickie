todo:
- even prettier wiki and tooltips
  - have tooltips tell you where you should find the API keys in your user settings
...
- figure out some way to autoclick "add to radarr" on downloads for PTP to Radarr. If possible.
  ...
  - figure out how to cannibalize the code of that to work for sonarr on places like nebulance or otw
    - possibly abuse the miniseries check from add-trackers to decide whether to show radarr or sonarr? god knows.

- the dream: butcher this into working on UNIT3D trackers as well

slowly but surely. I'm learning javascript doing this.
